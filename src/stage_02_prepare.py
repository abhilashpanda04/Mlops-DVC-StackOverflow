...
STAGE = "stage_02_prepare_data" ## <<< change stage name 
...
def main(config_path, params_path):
    ...
    #achieveing reproducibility
    random.seed(seed)

    artfacts=config["artifacts"]
    prepared_data_dir_path=os.path.join(artfacts["ARTIFACTS_DIR"],artfacts["PREPARED_DATA"])
